...
public interface TaskSlotTable<T extends TaskSlotPayload>
     ...
     *
     * @param jobId for which to return the set of {@link AllocationID}.  该job下每个subtask相关的slot
     ...
     * 移除任务  可以发现这里的 Task 实际上对应的是 Execution
     */
