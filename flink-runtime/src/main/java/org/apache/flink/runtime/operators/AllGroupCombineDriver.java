...
public class AllGroupCombineDriver<IN, OUT> implements Driver<GroupCombineFunction<IN, OUT>, OUT> {
    ...
    public void prepare() throws Exception {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug(
                    "GroupCombineDriver object reuse: "
    ...
    public void run() throws Exception {
        ...
        final MutableObjectIterator<IN> in =
                new CountingMutableObjectIterator<>(this.taskContext.<IN>getInput(0), numRecordsIn);
        ...
        if (objectReuseEnabled) {
            ...
            final NonReusingMutableToRegularIteratorWrapper<IN> inIter =
                    new NonReusingMutableToRegularIteratorWrapper<IN>(in, serializer);
