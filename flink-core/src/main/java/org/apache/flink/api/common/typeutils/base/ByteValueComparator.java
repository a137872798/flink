...
public class ByteValueComparator extends TypeComparator<ByteValue> {
    ...
    @Override
    public void writeWithKeyNormalization(ByteValue record, DataOutputView target)
            throws IOException {
        throw new UnsupportedOperationException();
    }

    @Override
    public ByteValue readWithKeyDenormalization(ByteValue reuse, DataInputView source)
            throws IOException {
        throw new UnsupportedOperationException();
    }
}
